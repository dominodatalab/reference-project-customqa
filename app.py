...
with container:
    ...
    if submit_button and not openai_key:
        st.error("OpenAI API key is missing.Please provide it in the sidebar or set it in an environment variable")
    elif submit_button and user_input and qa and openai_key:
